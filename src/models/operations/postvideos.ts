 ...
 * Locale for the generated video.
 */
export type PostVideosLocale = ClosedEnum<typeof PostVideosLocale>;
...
export type PostVideosRequestBody = {
   ...
   * Locale for the generated video.
   */
  locale?: PostVideosLocale | undefined;
  /**
...
/** @internal */
export const PostVideosLocale$inboundSchema: z.ZodNativeEnum<
  typeof PostVideosLocale
> = z.nativeEnum(PostVideosLocale);

/** @internal */
export const PostVideosLocale$outboundSchema: z.ZodNativeEnum<
  typeof PostVideosLocale
> = PostVideosLocale$inboundSchema;

/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace PostVideosLocale$ {
  /** @deprecated use `PostVideosLocale$inboundSchema` instead. */
  export const inboundSchema = PostVideosLocale$inboundSchema;
  /** @deprecated use `PostVideosLocale$outboundSchema` instead. */
  export const outboundSchema = PostVideosLocale$outboundSchema;
}
...
/** @internal */
export const PostVideosRequestBody$inboundSchema: z.ZodType<
  PostVideosRequestBody,
  z.ZodTypeDef,
  unknown
> = z.object({
  content_type: ContentType$inboundSchema.default("Custom"),
  locale: PostVideosLocale$inboundSchema.default("auto"),
...
/** @internal */
export type PostVideosRequestBody$Outbound = {
  content_type: string;
  locale: string;
...
/** @internal */
export const PostVideosRequestBody$outboundSchema: z.ZodType<
  PostVideosRequestBody$Outbound,
  z.ZodTypeDef,
  PostVideosRequestBody
> = z.object({
  contentType: ContentType$outboundSchema.default("Custom"),
  locale: PostVideosLocale$outboundSchema.default("auto"),
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace PostVideosRequestBody$ {
  /** @deprecated use `PostVideosRequestBody$inboundSchema` instead. */
  export const inboundSchema = PostVideosRequestBody$inboundSchema;
  /** @deprecated use `PostVideosRequestBody$outboundSchema` instead. */
  export const outboundSchema = PostVideosRequestBody$outboundSchema;
  /** @deprecated use `PostVideosRequestBody$Outbound` instead. */
  export type Outbound = PostVideosRequestBody$Outbound;
}

export function postVideosRequestBodyToJSON(
  postVideosRequestBody: PostVideosRequestBody,
): string {
  return JSON.stringify(
    PostVideosRequestBody$outboundSchema.parse(postVideosRequestBody),
  );
}

export function postVideosRequestBodyFromJSON(
  jsonString: string,
): SafeParseResult<PostVideosRequestBody, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => PostVideosRequestBody$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'PostVideosRequestBody' from JSON`,
  );
}
