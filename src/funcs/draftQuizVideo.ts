...
export function draftQuizVideo(
  ...
  Result<
    ...
    | errors.DraftQuizVideoResponseBody
    | errors.DraftQuizVideoResponseResponseBody
    | ShortGeniusError
...
> {
  ...
  >(
    ...
    M.jsonErr(400, errors.DraftQuizVideoResponseBody$inboundSchema),
    M.jsonErr(401, errors.DraftQuizVideoResponseResponseBody$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
