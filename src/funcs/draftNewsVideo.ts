...
export function draftNewsVideo(
  ...
  Result<
    ...
    | errors.DraftNewsVideoResponseBody
    | errors.DraftNewsVideoResponseResponseBody
    | ShortGeniusError
...
> {
  ...
  >(
    ...
    M.jsonErr(400, errors.DraftNewsVideoResponseBody$inboundSchema),
    M.jsonErr(401, errors.DraftNewsVideoResponseResponseBody$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
