 ...
 */
export function videosPostVideos(
  ...
  Result<
    components.Video,
    | errors.PostVideosResponseBody
    | errors.PostVideosVideosResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PostVideosRequestBody$outboundSchema.optional().parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.Video$inboundSchema),
    M.jsonErr(400, errors.PostVideosResponseBody$inboundSchema),
    M.jsonErr(401, errors.PostVideosVideosResponseBody$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
