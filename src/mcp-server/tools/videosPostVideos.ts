...
const args = {
  request: operations.PostVideosRequestBody$inboundSchema.optional(),
};

export const tool$videosPostVideos: ToolDefinition<typeof args> = {
  name: "videos_post-videos",
...
Once you (or your LLM) are happy, you can pass the content to this endpoint to create and render the video.`,
  ...
  tool: async (client, args, ctx) => {
    const [result, apiCall] = await videosPostVideos(
      client,
      args.request,
