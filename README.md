...
Official SDK for the [ShortGenius](https://www.shortgenius.com/) API.
...
The SDK can be installed with either [npm](https://www.npmjs.com/), [yarn](https://classic.yarnpkg.com/en/), [pnpm](https://pnpm.io/), or [bun](https://bun.sh/) package managers.
