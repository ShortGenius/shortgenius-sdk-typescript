...
```bash
npm add https://github.com/ShortGenius/shortgenius-sdk-typescript
```

### PNPM

```bash
pnpm add https://github.com/ShortGenius/shortgenius-sdk-typescript
```

### Bun

```bash
bun add https://github.com/ShortGenius/shortgenius-sdk-typescript
```

### Yarn

```bash
yarn add https://github.com/ShortGenius/shortgenius-sdk-typescript zod
